...
public static class SourceGenerationHelper {
    ...
    internal static string ImplementDisposablePattern(TypeToGenerate classToGenerate) {
    ...
    private static void GenerateBaseImplementation(ICsFileBuilder builder, TypeToGenerate classToGenerate) {
    ...
    private static void GenerateDisposableImplementation(ICsFileBuilder builder, string interfaceName, bool isAsync, TypeToGenerate classToGenerate) {
    ...
    private static ICsFileBuilder AddDisposeBoolean(this ICsFileBuilder builder,
        bool isAsync,
        TypeToGenerate disposableToGenerate) {
        if (isAsync) {
    ...
    private static void AddDisposeBooleanLogic(this ICsFileBuilder builder, TypeToGenerate disposableToGenerate) {
    ...
    private static void AddDisposeAsyncBooleanLogic(this ICsFileBuilder builder, TypeToGenerate disposableToGenerate) {
        string methodPrefix = disposableToGenerate.IsSealed ? "private" : "protected virtual";
    ...
    private static string[] GetSetNullStatements(TypeToGenerate disposableToGenerate) {
